...
The data used in this tutorial is the concatenated alignment generated before `3_Dataset.nex`. Please download the data from [here](https://github.com/niklas-w/Molecular-systematics-course/tree/master/Data/3_Dataset.nex).
