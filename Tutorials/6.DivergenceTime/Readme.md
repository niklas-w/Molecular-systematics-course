...
The data used in this tutorial are the cleaned version of the alignments generated in the tutorial Multiple Sequence Alignment. Please download the data from [here](https://github.com/niklas-w/Molecular-systematics-course/tree/master/Data/6.Dataset.nex).
